...
public class MountainElement implements  ViewElement{
    @Override
    ...
    public void paintBox(int x, int y, GraphicsContext graphicsContext, int width, int height) {
        ...
        Image image = ImageCache.getImage("file:src\\main\\resources\\view\\762488.png");
    ...
    public Image getImage() {
        return ImageCache.getImage("file:src\\main\\resources\\view\\762488.png");
    }
}
